...
def print_taxa():
    ...
    tt = str(ord(dado1) + ord(dado2)*256.0)
    texto2.setText("taxa: "+tt.zfill(3)+"ms" )
...
p1.addItem(texto2)
texto2.setPos(650,4.5) # adiciona o texto na posicao (x,x) do grafico
...
botao3.clicked.connect(print_taxa)
